...
public class MainApp {
	...
	* 채팅 관련 끝
	...
	private boolean hasSession=false;//세션보유 여부
...
//		}
		...
		lblNewLabel_1.setIcon(new ImageIcon("D:\\eclipse-workspace\\login\\src\\res\\minizi.png"));
...
//      p_west_south_chat.setLayout();
		...
		btnHamburger.setIcon(new ImageIcon("D:\\eclipse-workspace\\login\\src\\res\\hamburger.png"));
		...
		btnSearch.setIcon(new ImageIcon("D:\\eclipse-workspace\\login\\src\\res\\magnifier.png"));
		...
		btnPreferences.setIcon(new ImageIcon("D:\\eclipse-workspace\\login\\src\\res\\gear.png.png"));
		...
		p_center_chat.add(p_center_chat_center, BorderLayout.SOUTH);
		...
		JPanel p_myChat_test_1 = new JPanel() {
			protected void paintComponent(Graphics g) {
				...
				ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\login\\src\\res\\chat_human.png");
